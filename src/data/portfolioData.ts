...
export const CERTIFICATIONS_DATA: CertificationItem[] = [
  ...
  {
    id: "cert-11",
    title: "Praktik Asuhan Keperawatan Komprehensif",
    category: "KLINIS",
    year: "2024",
    description: "Implementasi proses keperawatan langsung di tatanan rumah sakit, pemantauan tanda vital, dan pendokumentasian rekam medis.",
    issuer: "Fakultas Keperawatan IIK NU Tuban",
    iconName: "assignment_turned_in",
    badgeClass: "green",
    credentialId: "PKK-IIKNU-2024-8821",
    skills: ["Pemeriksaan Tanda Vital", "Dokumentasi SOAPIE", "Komunikasi Terapeutik", "Administrasi Rekam Klinis"],
    imageUrl: "/assets/sertifikat-11.jpg",
  },
  {
    id: "cert-12",
    title: "Administrasi Layanan Kesehatan & Literasi Digital",
    category: "ADMINISTRASI",
    year: "2024",
    description: "Pengolahan pelaporan rekam medik, pembukuan administrasi fasyankes harian, dan digitalisasi data layanan pasien.",
    issuer: "Lembaga Pendidikan Vokasi & Kesehatan",
    iconName: "folder_managed",
    badgeClass: "amber",
    credentialId: "ADM-KES-2024-5542",
    skills: ["Entri Data Rekam Medis", "Pengoperasian MS Office", "Manajemen Arsip Pasien", "Validasi Laporan Harian"],
    imageUrl: "/assets/sertifikat-12.jpg",
  },
];